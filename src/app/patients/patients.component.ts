...
export class PatientsComponent implements OnInit {
  ...
  selectedPatient : PatientModel = new PatientModel(null,null,null,null,null,null,null,null,null,null,null);
  inputId:string;
  ...
  createPatient() {
    var newPatient:PatientModel = new PatientModel(null,null,null,null,true,"unknown",null,false,null,false,null)
